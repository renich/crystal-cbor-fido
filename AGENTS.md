...
## Project Domain: CBOR Encoding/Decoding for FIDO protocols

### Domain-Specific Knowledge
- Memory-safe parsing of CBOR streams using strict boundary limits to prevent buffer overflows.
- Deterministic byte-array representations to comply with FIDO/WebAuthn assertions.
